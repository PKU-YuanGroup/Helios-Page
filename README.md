...
* `[2026.03.06]` 🚀 We fix the Parallel Inference logits for Helios, and provide an example [here](#-context-parallelism-on-multiple-gpus). Thanks [Cache-DiT Team](https://github.com/vipshop/cache-dit/pull/836). 
